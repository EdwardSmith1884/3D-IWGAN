...
parser.add_argument('-d','--data', default='data/chairs', help ='The location for the object voxel models.' )
parser.add_argument('-i','--images', default='overlays/chairs', help ='The location for the images.' )
...
with tf.variable_scope("all"):
    ...
    ############ Optimization #############
    v_vars = net_m.all_params + list(set(net_s.all_params)-set(net_m.all_params)) 
